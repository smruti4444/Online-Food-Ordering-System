														 ...
														 <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
																<div class="right-content bg-white">
																	<div class="right-review">
                                                                        ...
                                                                        <p>'.$rows['review'].' Reviews</p> <a href="dishes.php?res_id='.$rows['rs_id'].'" class="btn theme-btn-dash">View Menu</a> </div>
																</div>
																<!-- end:right info -->
															</div>';
										  }
                    ...
                    <div class="row top-footer">
                        ...
                        <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Patel Nagar</a> </li>
                                <li><a href="#">Lajpat Nagar</a> </li>
                                <li><a href="#">shadipur</a> </li>
                                <li><a href="#">Karol Bhagh</a> </li>
                                <li><a href="#">kirti Nagar</a> </li>
                                <li><a href="#">Tilak Nagar</a> </li>
                                <li><a href="#">Jankpuri</a> </li>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    ...
                                    <h5>Phone: <a href="tel:+080000012222">+9876543210</a></h5> </div>
